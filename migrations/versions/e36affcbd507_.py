...
def upgrade():
    ...
    sa.Column('highest_education', sa.Enum('HIGH_SCHOOL', 'GRADUATE', 'POST_GRADUATE', 'DOCTORATE', name='highesteducation'), nullable=True),
    sa.Column('english_speaking_level', sa.Enum('BASIC', 'INTERMEDIATE', 'FLUENT', 'NO_ENGLISH', name='englishspeakinglevel'), nullable=True),
    ...
    sa.Column('preferred_employment_type', sa.Enum('FULL_TIME', 'PART_TIME', 'CONTRACT', name='employmenttype'), nullable=True),
    sa.Column('preferred_work_place_type', sa.Enum('OFFICE', 'WORK_FROM_HOME', 'WORK_FROM_FIELD', name='workplacetype'), nullable=True),
